...
def calibration():
    ...
    #get glob images
    images = glob.glob('/home/rilab-orin-1/workspace/zed_sam/data/*.jpg')
    ...
    matrix_path = "/home/rilab-orin-1/workspace/zed_sam/data/"+"intrinsic_matrix"+".jpg"

    np.save(matrix_path, mtx)
...
def main():
    ...
    for i in range(10):
        ...
        if err == sl.ERROR_CODE.SUCCESS:
            ...
            path = "/home/rilab-orin-1/workspace/zed_sam/data/"+"calibration_"+str(i)+".jpg"
            print("path", path)
