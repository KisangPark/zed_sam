...
if __name__ == "__main__":
    ...
    parser.add_argument("--image", type=str, default="assets/frog.jpg")
    parser.add_argument("--prompt", type=str, default="[a frog]")
    parser.add_argument("--threshold", type=str, default="0.1,0.1")
    parser.add_argument("--output", type=str, default="assets/frog_predict.jpg")
    ...
    text = prompt.split(',')
    print(text) #["a frog"], list of string
